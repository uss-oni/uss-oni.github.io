  ...
  public static partial class Components
  {
    ...
    public static void Get(Entity entity, DecorProvider component)
    {
      if (component.baseDecor != 0f)
      {
        ...
        entity.decor_radius = component.baseRadius;
      }
    }
    ...
    public static void Get(Entity entity, EnergyConsumer component)
    {
      ...
      {
        entity.electrity_consummation = [component.WattsNeededWhenActive];
      }
      else
      {
        entity.electrity_consummation[0] = component.WattsNeededWhenActive;
      }
    }
    public static void Get(Entity entity, RequireInputs component) { }
    public static void Get(Entity entity, Floodable component)
    {
      entity.flood_threshold = 0.35f;
    }
    ...
    {
      entity.trap_critters = component.trappableCreatures.Select(t => t.Name).ToList();
    }
    ...
    {
      entity.mass_per_unit = component.GetComponent<PrimaryElement>().MassPerUnit;
    }
    ...
    public static void Get(Entity entity, Edible component)
    {
      ...
      entity.menu_order = info.Quality;
      if (info.CanRot)
      {
        entity.spoil_time = info.SpoilTime;
      }
      else
      {
        entity.spoil_time = 0;
    ...
    public static void Get(Entity entity, CreatureBrain component)
    {
      if (entity.menu_order > 10000)
      {
        ...
        entity.menu_order = Array.IndexOf(order, component.species);
        if (entity.menu_order < 0)
        {
    ...
    {
      entity.high_temp_fatal = component.TemperatureLethalHigh;
      entity.high_temp_warning = component.TemperatureWarningHigh;
      entity.low_temp_fatal = component.TemperatureLethalLow;
      entity.low_temp_warning = component.TemperatureWarningLow;
    }
    ...
    {
      entity.menu_order = (int)GeyserConfigurator.FindType(component.presetType).shape;
