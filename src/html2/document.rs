...
pub trait ExtendHtml {
  fn add_div(&self, class: Option<&str>) -> HtmlDivElement;
  fn add_img(&self, img: &dyn Image) -> HtmlImageElement;
  fn add_p(&self) -> HtmlParagraphElement;
  fn add_text(&self, text: &str) -> web_sys::Text;
  fn add_h3(&self, text: &str) -> HtmlHeadingElement;
  fn add_option(&self, value: &str, label: &str) -> HtmlOptionElement;
...
pub trait ExtendDocument {
  fn get_element<T: wasm_bindgen::JsCast>(&self, id: &str) -> T;
